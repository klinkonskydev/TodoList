                    ...
                    <TodoContainer key={item.id} className={item.completed ? 'checked' : ''}>
                        <NameContainer>
                            <span onClick={() => handleCheck(item)}>
                                <svg width="100%" height="100%" viewBox="0 0 24 24" stroke="#00AF00" strokeWidth="1" strokeLinecap="square" strokeLinejoin="miter" fill="none" color="#000"> <title id="okIconTitle">Ok</title> <polyline points="4 13 9 18 20 7"/> </svg>
                            </span>
